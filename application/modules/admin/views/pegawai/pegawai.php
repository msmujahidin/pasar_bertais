        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Kelola Pegawai</h6>
            </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              ...
              <a href="<?php echo site_url('admin/pegawai/create'); ?>" class="btn btn-sm btn-primary">Tambah Pegawai</a>
            </div>
  ...
  <div class="modal-dialog modal-modal-dialog-centered modal-" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h6 class="modal-title" id="modal-title-default">Hapus Pegawai?</h6>
          ...
          <div class="modal-body">
              <p>Yakin ingin hapus pegawai ini? Semua data seperti data profil, order dan pembayaran juga akan dihapus.</p>
          </div>
...
$(document).ready(function() {
    ...
    var table = $('#customerList').DataTable({
      "ajax" : "<?php echo site_url('admin/pegawai/api/pegawai'); ?>",
      "columns" : [
        {"data": "id"},
