...
<div class="container-fluid mt--6">
                    ...
                    <div class="card-body p-0">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <td>Penjual</td>
                                <td>:</td>
                                <td><b><?php echo $product->penjual; ?></b></td>
                            </tr>
                            <tr>
                                <td>No HP</td>
                                <td>:</td>
                                <td><b><?php echo $product->no_hp; ?></b></td>
                            </tr>
                            <tr>
                                <td>Lokasi</td>
                                <td>:</td>
                                <td><b><?php echo $product->lokasi; ?></b></td>
                            </tr>
                            <td>SKU</td>
                            <td>:</td>
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="<?php echo site_url('admin/grosir/add/'. $product->id); ?>"
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col">Jumlah Minimal</th>
                            ...
                            <tbody>
                                <?php foreach ($harga_grosir as $grosir) : ?>
                                <tr>
                                    <td>
                                        <?php echo $grosir->jumlah_minimal; ?>
                                    </td>
                                    <td>Rp <?php echo format_rupiah($grosir->harga_satuan); ?></td>
                                    <td>Rp <?php echo format_rupiah($grosir->harga_coret); ?></td>
                                    <td>
                                        <a href="<?php echo site_url('admin/grosir/edit/'. $grosir->id); ?>"
                                            class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                        <button onclick="mDelete('<?php echo $grosir->id;?>','<?php echo $grosir->product_id;?>');" class="btn btn-danger btn-sm">
    ...
    <script>
    var url="<?php echo site_url('admin/grosir/delete/');?>";
          function mDelete(id,product_id){
            var r=confirm("Do you want to delete this?")
              if (r==true)
                window.location = url+id+"/"+product_id;
              else
                return false;
          } 
