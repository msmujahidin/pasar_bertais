            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="no_sequence" value="<?php echo set_value('no_sequence', $product->no_sequence); ?>" class="form-control" id="no_sequence">
                  <?php echo form_error('no_sequence'); ?>
                </div>
                <div class="form-group">
                  <label class="form-control-label" for="name">No lokasi:</label>
                  <input type="text" name="no_location" value="<?php echo set_value('no_location', $product->no_location); ?>" class="form-control" id="no_location">
