            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="penjual" value="<?php echo set_value('penjual', $product->penjual); ?>" class="form-control" id="penjual">
                  <?php echo form_error('penjual'); ?>
                </div>
                <div class="form-group">
                  <label class="form-control-label" for="name">No HP:</label>
                  <input type="text" name="no_hp" value="<?php echo set_value('no_hp', $product->no_hp); ?>" class="form-control" id="no_hp">
                  <?php echo form_error('no_hp'); ?>
                </div>
                <div class="form-group">
                  <label class="form-control-label" for="name">Lokasi:</label>
                  <input type="text" name="lokasi" value="<?php echo set_value('lokasi', $product->lokasi); ?>" class="form-control" id="lokasi">
