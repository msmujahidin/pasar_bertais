...
<div class="container-fluid mt--6">
    <div class="row">
        <div class="col">
            <div class="card">
                <!-- Card header -->
                <form action="<?php echo site_url('admin/orders/exportAll/'); ?>" method="POST">
                    <div class="card-header">
                        <h3 class="mb-0">Kelola Order</h3>
                        <button type="submit" class="btn btn-outline-primary"><i class="fa fa-download"></i>
                            Export</button>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo site_url('admin/products/add_new_product'); ?>"><i
                                    class="fa fa-plus"></i> Tambah produk baru</a>
                            <br>
